...
Podatke sem uvažal iz [spletne strani SURS](https://pxweb.stat.si/SiStat/sl) ter iz [spletne strani ARSO](http://meteo.arso.gov.si/met/sl/archive/). Podatke sem uredil v tri glavne tabele.
...
- `naselje` - ime naselja
- `leto` - leto
- `avg_t` - povprečje povprečnih mesečnih temperatur za dano leto
...
Za začetno predstavo na zgornjem grafu lahko vidimo kako temperature in
padavine se spreminjajo tekom leta 2010. Podobne rezultate lahko vidimo za ostala
